# Setsail Hub Project Management
...
1. Clone the repository:
   ```bash
   git clone https://github.com/septiandwica
...
4. Configure database in `.env` file:
   ...
   DB_HOST=127.0.0.1
   DB_PORT=3306
   DB_DATABASE=project_management_setsail
   DB_USERNAME=root
   DB_PASSWORD=
   ```
...
4. **Create OAuth 2.0 Credentials**
   ...
   - Enter application name (example: " Project Management")
...
MAIL_FROM_NAME="Project Management Setsail Hub"
```
